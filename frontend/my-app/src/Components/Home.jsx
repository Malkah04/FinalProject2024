    ...
    <div className='home-page'>
      <div className="contact-home">
        ...
        <div className="hero">
                ...
                <p className="animation">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Minima, explicabo placeat.  molestiae  ipsa fugiat ipsam neque atque perferendis minus quibusdam voluptates, veniam laboriosam?</p>
